...
public class MonsterController : MonoBehaviour
{
    ...
    // Add reference for the Game Over and Win UI screens
    public GameObject gameWinScreen; // Reference to the win screen
    public GameStartController gameStartController; // Reference to the GameStartController to handle game win
    ...
    void Start()
    {
        ...
        // Ensure Game Over and Win screens are hidden at the start
        if (gameWinScreen != null)
        {
            gameWinScreen.SetActive(false); // Hide the win screen at the start
        }
    ...
    public void Die()
    {
        ...
        // If this is the boss, show the win screen
        if (gameObject.CompareTag("Boss"))
        {
            if (gameStartController != null)
            {
                gameStartController.ShowWinScreen(); // Show win screen when boss dies
            }

            if (gameWinScreen != null)
            {
                gameWinScreen.SetActive(true); // Show the win screen UI panel
            }
        }
    }
